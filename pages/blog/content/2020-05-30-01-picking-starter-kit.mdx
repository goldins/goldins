...
This post will explore choosing a starter kit, using my experience building this blog as an example. This will be the first post in a series that comes out of working on this website.
...
By checking before I started I avoided some headache down the road. If I had gone with an outdated template, I would have had to rely on old documentation, I'd likely miss out on useful functionality, and ultimately I'd have to update dependencies myself.
...
This was one of the options using the installer (`create next-app`), and although some dependencies were a bit outdated, it looked like a good base. ESLint, Prettier, Jest and react-testing-library were all included, and there were a few bare-bone files (including tests!) that I could start with.
